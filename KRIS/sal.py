...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token='Eo6eVxFjVxOSsxnglJdc.i61D3SdDbsp5YV/TzZ1Ppa.8HHfGUFh129jvpAL1Kaa8Un7oA6jTA5vbHIjK0dChUY=')
kr.loginResult()
...
Bots=[mid]
admin=["u23ad5ddec0dd0523f9caffad673d693c",mid]
...
wait = {
    ...
    'message':"""Thx for add""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By Faisal\n\n☆º°˚˚✰ Team Chucky ✰º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Faisal 👈 »»» http://line.me/ti/p/~Faisal501 «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","Faisal lagi off, ", cName + " Kenapa Tag saya?, ","PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["lang"] == "JP":
                    ...
                    kr.sendText(msg.to,helpself)
            elif msg.text.lower() == 'helpgrup':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpgrup)
                else:
                    kr.sendText(msg.to,helpgrup)
            elif msg.text.lower() == 'helpset':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpset)
                else:
                    kr.sendText(msg.to,helpset)
            elif msg.text.lower() == 'helptran':
                if wait["lang"] == "JP":
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["cancelprotect"] == False:
                    ...
                    try:
                        kr.getContact(msg.from_)
                        kr.sendText(msg.to,"Bahasa di jaga")
                        kr.kickoutFromGroup(msg.to,[msg.from_])
                    except:
                        pass
              ...
              if msg.from_ in admin:
                if msg.to in wait['pname']:
                    kr.sendText(msg.to,"ƬƲƦƝЄƊ ƠƝ.")
                else:
                    kr.sendText(msg.to,"ƛԼƦЄƛƊƳ ƠƝ")
                    wait['pname'][msg.to] = True
                    wait['pro_name'][msg.to] = kr.getGroup(msg.to).name
            elif "Namelock:off" in msg.text:
              if msg.from_ in admin:
                if msg.to in wait['pname']:
                    kr.sendText(msg.to,"ƬƲƦƝ ƠƑƑ.")
                    del wait['pname'][msg.to]
                else:
                    kr.sendText(msg.to,"ƛԼƦЄƛƊƳ ƠƑƑ")
                ...
                #msg.contentType = 13
                #msg.contentMetadata = {'mid': "u23ad5ddec0dd0523f9caffad673d693c"}
                #kr.sendMessage(msg)
            elif cms(msg.text,["creator","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u23ad5ddec0dd0523f9caffad673d693c"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang manis  􀜁􀄯􏿿')
...
#=====================================
                    ...
                    for song in data:
                      ...
                      hasil += ')\n\n'
                      hasil += song[5]
                      kr.sendText(msg.to, "Lagu " + song[0] + "\nSedang Di Prosses...")
                      kr.sendAudioWithURL(msg.to,abc)
                      kr.sendText(msg.to, "Title : " + song[0] + "\nLength : " + song[1] + "\nLink download : " + song[4] +"\n\n" + hasil)
...
#==============================================================================#
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                ...
                if msg.to not in wait2['readPoint']:
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        kr.sendText(msg.to, "Ketik [Setview] for [Lurkers]")
            ...
            elif msg.text in ["toong","Toong","viewseen"]:
                 if msg.toType == 2:
                    print "\nRead aktif..."
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                        ...
                        kr.sendText(msg.to, "Ketik [Setview] dulu, baru ketik [Viewseen]")                                  
                ...
                kr.sendText(msg.to,"Video Has Been Set To")
                    ...
                    for count in range(1, 999):
                        ...
                        for node in j['entry_data']['ProfilePage'][0]['user']['media']['nodes']: 
                            if node['is_video']:
                                ...
                                print(url)
                                kr.sendVideoWithURL(msg.to,url)
                            else:
                                print (node['display_src'])
                                kr.sendImageWithURL(msg.to,node['display_src'])
...
#================================ KRIS SCRIPT STARTED ==============================================#
                    ...
                    b = urllib.quote(a)
                    kr.sendText(msg.to,"Sedang Mencari...")
